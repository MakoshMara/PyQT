...
from common.variables import ACTION, PRESENCE, TIME, USER, ACCOUNT_NAME, DEFAULT_IP_ADRESS, DEFAULT_PORT, \
    RESPONSE, ERROR, MESSAGE, EXIT, DESTINATION, USERS_REQUEST, LIST_INFO, REMOVE_CONTACT, ADD_CONTACT, GET_CONTACTS
import time
...
def add_contact(sock, username, contact):
    ...
    send_meccage(sock, req)
    ans = get_message(sock)
    print('получили ответ от сервера')
